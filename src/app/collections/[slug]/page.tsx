    ...
    <>
      ...
      <main className="flex-1 bg-brand-ivory pt-24 pb-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative rounded-lg overflow-hidden border border-brand-gold/15 bg-brand-charcoal text-brand-ivory mt-6 mb-12 shadow-sm">
            {/* Background Image */}
            ...
            {/* Content */}
            <div className="relative z-10 px-6 py-12 sm:p-12 md:p-16 max-w-2xl space-y-6">
              ...
              <div className="pt-2">
                <a
                  ...
                  className="inline-flex items-center gap-2 rounded-full bg-brand-rose px-6 py-3 font-sans text-xs font-bold tracking-widest uppercase text-white hover:bg-brand-rose/90 transition-all duration-300"
                >
                  <span>Enquire Collection Options</span>
          ...
          <div className="space-y-6">
            <h2 className="font-serif text-2xl font-medium text-brand-charcoal border-b border-brand-gold/15 pb-3">
            ...
            {products.length === 0 ? (
              <div className="text-center py-16 bg-white border border-brand-gold/10 rounded-lg">
                ...
                <div className="mt-6 flex justify-center gap-3">
                  <Link
                    href="/customize"
                    className="rounded-full bg-brand-rose px-6 py-2.5 font-sans text-xs font-semibold tracking-wider uppercase text-white hover:bg-brand-rose/90 transition-all"
                  >
